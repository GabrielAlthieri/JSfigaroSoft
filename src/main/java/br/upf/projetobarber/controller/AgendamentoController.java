...
import br.upf.projetobarber.facade.AgendamentoFacade;
...
public class AgendamentoController implements Serializable {
     ...
     */
    public List<AgendamentoEntity> buscarPorBarbeiro(Integer barbeiroId) {
        return ejbFacade.buscarPorBarbeiroId(barbeiroId);
    }
